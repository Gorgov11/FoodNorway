...
class KiwiScraper extends BaseScraper {
  constructor() {
    super();
    this.baseUrl = 'https://www.kiwi.no';
    this.productUrl = 'https://www.kiwi.no/api/products';
  }

  /**
   * Scrape all products from Kiwi
   */
  async scrapeAllProducts() {
    try {
      ...
      console.error('Error scraping Kiwi products:', error);
      throw error;
    }
  }
