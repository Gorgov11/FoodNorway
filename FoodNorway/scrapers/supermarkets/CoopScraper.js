...
class CoopScraper extends BaseScraper {
  constructor() {
    super();
    this.baseUrl = 'https://www.coop.no';
    this.productUrl = 'https://www.coop.no/api/products';
  }

  /**
   * Scrape all products from Coop
   */
  async scrapeAllProducts() {
    try {
      ...
      console.error('Error scraping Coop products:', error);
      throw error;
    }
  }
